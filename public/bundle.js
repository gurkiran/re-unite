...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cityTemplate = '<div class="city"><div class="city-image "style="background:url(<%= img %>); background-size: cover;">' + '</div><div class="city-name">' + '<%= name.toUpperCase() %></div>' + '</div> ';
	...
	var updateCityList = function updateCityList() {
	  var citydata = cities[cities.length - 1];
	  makeTemplate(citydata);
	  $('.add-city').hide();
	};

	var makeCityList = function makeCityList(cities, addCity) {
	  if (addCity) {
	    $('.add-city').show();
	  } else {
	...
	var getAllCities = function getAllCities() {
	  window.fetch('/cities').then(function (resp) {
	    return resp.json();
	  }).then(function (data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module, global) {var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
